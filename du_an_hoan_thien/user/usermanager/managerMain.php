            ...
            <div class="row">
                <div class="col-3">
                    <div class="admin-left">
                        <div class="admin-left-icon text active">
                ...
                <div class="col-9">
                    <div class="admin-right">
                        <!-- == hồ sơ === -->
                        <div class="admin-right-item active">
                            <div class="admin-right-item-header">
                                <div class="admin-right-item-header-item active">Hồ Sơ</div>
                                <div class="admin-right-item-header-item">Bảo Mật</div>
                            </div>
                            <div class="admin-right-item-content">
                                <form method="post" id="userProfile" class="admin-right-item-content-item active">
                        ...
                        <div class="admin-right-item">
                            <div class="admin-right-item-header">
                                <div class="admin-right-item-header-item active">Đang Đọc</div>
                                <div class="admin-right-item-header-item">Đánh Dấu</div>
                                <div class="admin-right-item-header-item">Truyện Đã Đăng</div>
                            </div>
                            <div class="admin-right-item-content">
                                <div class="admin-right-item-content-item admin-right-item-content-read active">
                        ...
                        <div class="admin-right-item">
                            <div class="admin-right-item-header">
                                <div class="admin-right-item-header-item active">Nhiệm Vụ Ngày</div>
