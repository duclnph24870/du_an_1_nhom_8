        ...
        <div class="admin-right">
            <div class="admin-right-item active admin-right-item-productList">
                <div class="admin-right-item-header">
                    <div class="admin-right-item-header-item active">Thêm Chương</div>
                            ...
                            <table class="table-list__content">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2 giờ trước</td>
                                        <td><a href="indexAdminTruyen.php?editChuong=1?idChuong=0" class="editTruyen" title="Sửa Chương"><i class="fad fa-edit"></i></a><input type="checkbox" name="chuongCheckBox" class="chonCheckBox"></td>
                                    </tr>
